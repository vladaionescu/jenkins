...
jenkins-image:
    ...
    COPY +jre-build/javaruntime $JAVA_HOME
    ...
    COPY docker/jenkins-plugin-cli.sh /bin/jenkins-plugin-cli
    ...
    SAVE IMAGE --push vladaionescu/test:jenkins-earthly
